        ...
        <ScrollAnimation direction="left">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-16">
            ...
            <div className="relative">
              <img src={sectionBg} alt="Real estate" className="rounded-xl w-full h-72 object-cover" />
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex justify-center gap-3 flex-wrap">
              {["Customer Satisfaction", "Integrity", "Excellence"].map((v) => (
                <Badge key={v} variant="outline" className="px-6 py-2 text-sm border-primary text-primary rounded-full">{v}</Badge>
              ))}
            </div>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation direction="up">
          <div className="text-center mb-10">
            ...
            <div className="flex justify-end mt-4">
              <Link to="/about">
                <Button className="btn-primary rounded-full">View All Members</Button>
              </Link>
            </div>
          </div>
        </ScrollAnimation>
