          ...
          <ScrollAnimation direction="right">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-start gap-3 p-4 bg-card border border-border rounded-lg">
                ...
                <div className="text-sm">
                  ...
                  >
                    +234-810-681-5300 (Call/WhatsApp)
                  </a>
                  <a
                    href="tel:+2349037075934"
                    className="text-muted-foreground hover:text-primary block"
                  >
                    +234-903-707-5934 (Call/WhatsApp)
                  </a>
                  <a href="tel:+2348159160550" className="text-primary block">
                    +234-815-916-0550 (Call/WhatsApp)
                  </a>
                </div>
              </div>
              <div className="flex items-start gap-3 p-4 bg-card border border-border rounded-lg">
            ...
            <div className="space-y-6">
              <div className="rounded-lg overflow-hidden border border-border">
                <h3 className="p-3 bg-card font-semibold text-sm border-b border-border">
                  Abuja Office
                </h3>
                <iframe
                  width="100%"
                  ...
                  marginHeight={0}
                  marginWidth={0}
                  src="https://maps.google.com/maps?q=Anon%20Plaza,%20Gudu%20District,%20Abuja&t=&z=15&ie=UTF8&iwloc=&output=embed"
              ...
              <div className="rounded-lg overflow-hidden border border-border">
                ...
                <iframe
                  ...
                  marginHeight={0}
                  marginWidth={0}
                  src="https://maps.google.com/maps?q=Skymall,%20Sangotedo,%20Lekki,%20Lagos&t=&z=15&ie=UTF8&iwloc=&output=embed"
