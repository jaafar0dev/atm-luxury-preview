...
const BookConsultation = () => {
  ...
  return (
    <PublicLayout>
      <PageHero
        title="Expert Real Estate Consultation"
        subtitle="Connect with our luxury property specialists for personalized guidance tailored to your unique needs"
      />
      ...
      <section className="section-container py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">
            Fill out the form below and our experts will contact you to schedule
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <SelectContent>
                  <SelectItem value="Property Buying">
                    Property Buying
                  </SelectItem>
                  <SelectItem value="Property Investment">
                    Property Investment
                  </SelectItem>
              ...
              <Select
                ...
                onValueChange={(v) => setForm({ ...form, budgetRange: v })}
              >
                <SelectTrigger className="rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setForm({ ...form, preferredLocation: v })
                }
              >
                <SelectTrigger className="rounded-lg">
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full btn-gold rounded-full h-12"
            >
      ...
      <section className="section-container py-16">
        <ScrollAnimation direction="up">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground">
              Specialized expertise to guide you through every aspect of luxury
              real estate
            </p>
          </div>
        </ScrollAnimation>
          ...
          {[
            {
              ...
              desc: "Expert guidance on purchasing your dream property with tailored advice for your budget and preferences.",
            },
            {
              icon: TrendingUp,
            ...
            },
            {
              ...
              desc: "Comprehensive management services for landlords and property owners.",
            },
          ].map((s) => (
      ...
      <section className="section-container py-16">
        <ScrollAnimation direction="up">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground">
              A structured approach to ensure you receive comprehensive real
              estate guidance
            </p>
          </div>
        </ScrollAnimation>
          ...
          {[
            {
              ...
              desc: "Discuss your goals and requirements with our expert consultants",
            },
            {
              num: "02",
              title: "Market Analysis",
              desc: "Receive detailed market insights and property recommendations",
            },
            {
              num: "03",
              title: "Custom Strategy",
              desc: "Get a personalized action plan tailored to your objectives",
            },
            {
              num: "04",
              title: "Ongoing Support",
              desc: "Continuous assistance throughout your real estate journey",
            },
          ].map((step) => (
      ...
      <section className="section-container py-16">
        <ScrollAnimation direction="up">
          <div className="text-center mb-10">
            ...
            <p className="text-muted-foreground">
              Hear from clients who have benefited from our expert consultation
              services
            </p>
          </div>
        </ScrollAnimation>
      ...
      <section className="bg-primary py-16">
        <div className="section-container text-center">
          ...
          <p className="text-white/70 mb-6 max-w-xl mx-auto">
            Schedule your complimentary consultation with our luxury property
            experts today
          </p>
          <Link to="/listings">
            <Button
              variant="outline"
              className="rounded-full border-white text-white bg-transparent hover:bg-white hover:text-primary"
            >
              Explore Properties
            </Button>
          </Link>
